...
const Education = () => (
  <section id="education" className="scroll-mt-24 border-t border-stone-900/[0.08]">
        ...
        {education.map((e, i) => (
          <motion.div
            ...
            className={`flex flex-col md:flex-row md:items-center gap-3 md:gap-8 p-6 md:p-8 ${
              i < education.length - 1 ? "border-b border-stone-900/[0.08]" : ""
            } hover:bg-stone-900/[0.02] transition-colors`}
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center gap-3">
                <h3 className="font-display text-xl md:text-2xl text-[#1c1917]">{e.school}</h3>
                {e.badge && (
